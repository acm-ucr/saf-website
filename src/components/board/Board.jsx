    ...
    >
      <div className="flex items-center justify-center relative w-36 md:w-full lg:w-[325px] 2xl:w-[400px] aspect-square">
        <Image
          src={mandala}
          alt="Mandala"
          className="opacity-20 group-hover:animate-spin-slow 2xl:w-full lg:w-5/6 md:w-9/12 w-full"
        />
        <Image
          src={image}
          alt="SAF Board Member"
          className="absolute 2xl:w-2/3 lg:w-3/5 md:w-1/2 w-2/3 aspect-square rounded-full object-cover"
        />
      </div>
