...
const WhyJoin = () => {
  return (
    <div className="w-full flex flex-row item-center justify-center bg-orange-50 px-14 py-14">
      <div className="flex flex-col w-1/2 px-10 py-10 pe-8 bg-saf-beige-200">
        ...
        <p className="text-saf-brown w-3/4 font-lora text-xl">
      ...
      <div className="px-20 py-8 flex flex-col w-1/4">
        <ul className="flex flex-col list-disc list-outside">
          <li className="mt-3 font-libre text-saf-brown leading-10 text-xl">
            Cultural Appreciation
          </li>
          <li className="font-libre text-saf-brown leading-10 text-xl">
            Inclusivity
          </li>
          <li className="font-libre text-saf-brown leading-10 text-xl">
            Community
